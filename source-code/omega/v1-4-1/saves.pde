...
void loadWorld(){
  String[] worldsave = loadStrings("saves/" + textEntry +  "-" + verCode + "/" + textEntry + "-" + verCode + ".slsav");
  String[] datasave = loadStrings("saves/" + textEntry +  "-" + verCode + "/" + textEntry + "-" + verCode + ".sldat");
...
void loadWorldButGangsterThisTime(){
  String[] worldsave = loadStrings("saves/" + worldName +  "-" + verCode + "/" + worldName + "-" + verCode + ".slsav");
  String[] datasave = loadStrings("saves/" + worldName +  "-" + verCode + "/" + worldName + "-" + verCode + ".sldat");
  if(worldsave == null || datasave == null){
    textEntry = "";
  }else{
    for(int i = 0; i < worldsave.length / 1000; i++){
